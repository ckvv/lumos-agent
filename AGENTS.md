...
- The workflow runs Electron Forge packaging on native macOS Apple Silicon, macOS Intel, and Windows runners, uploads `out/make/` as workflow artifacts, and uploads release assets for `v*` tag builds.
