...
- Prefer `@vueuse/core` composables over bespoke implementations when they fit the requirement; only write custom composables after confirming VueUse does not already cover the use case cleanly.
